...
const connectReadonlyContract = () => {
  ...
  const contract = new ethers.Contract(address, abi, providerETH);

  console.log(contract);
};

const connectHumanReadableReadonlyContract = async () => {
  const abi = [
  ...
  console.log(ethers.formatEther(await contract.totalSupply()));
};

const main = async () => {
  // connectReadonlyContract();
  connectHumanReadableReadonlyContract();
};
